import type { TenantAdminFeedback } from "../types";
import { EmptyState } from "../../../components/ui/EmptyState";
import { ErrorNotice } from "../../../components/ui/ErrorNotice";
import { SkeletonBlock } from "../../../components/ui/SkeletonBlock";

const feedbackClassNames: Record<TenantAdminFeedback["tone"], string> = {
...
export const TenantAdminEmptyState = ({
  title,
  message,
}: {
  title: string;
...
export const TenantAdminErrorNotice = ({
  title,
  message,
}: {
  title: string;
...
export const TenantAdminSectionSkeleton = ({
  rows = 4,
}: {
  rows?: number;
}): JSX.Element => (
  <div className="ui-panel p-6">
    ...
    <SkeletonBlock rows={rows} height="h-20" />
  </div>
);

export const TenantAdminFeedbackNotice = ({
  feedback,
}: {
  feedback: TenantAdminFeedback;
}): JSX.Element => (
  <div
