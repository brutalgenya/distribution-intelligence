import type { ActivationActionFeedback } from "../types";
import { EmptyState } from "../../../components/ui/EmptyState";
import { ErrorNotice } from "../../../components/ui/ErrorNotice";
import { SkeletonBlock } from "../../../components/ui/SkeletonBlock";

const feedbackClassNames: Record<ActivationActionFeedback["tone"], string> = {
...
export const ActivationEmptyState = ({
  title,
  message,
}: {
  title: string;
...
export const ActivationErrorNotice = ({
  title,
  message,
}: {
  title: string;
...
export const ActivationSectionSkeleton = ({
  rows = 4,
}: {
  rows?: number;
}): JSX.Element => (
...
export const ActivationFeedbackNotice = ({
  feedback,
}: {
  feedback: ActivationActionFeedback;
}): JSX.Element => (
  <div
